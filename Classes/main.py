...
from Classes.cleint import LanMultiplayer
...
class Game:
    def __init__(self, ):
        ...
        self.gameStateManager = GameStateManager('lanMultiplayer')
        ...
        self.lanMultiplayer = LanMultiplayer()
...
class Multiplayer:
    ...
    def run(self):
        ...
        localMultiplayerButton = Button(image=pygame.image.load("../assets/images/icons/Play Rect.png"), pos=(1040, 250),
